...
func main() {
	...
	agentTools := []tools.ToolDefinition{tools.ReadFileDefinition, tools.ListFilesDefinition, tools.BashDefinition, tools.EditFileDefinition, tools.CodeSearchDefinition}
